...
:HTML_CONTAINER_CLASS: save
:END:
- Download and save the [[./doc/pygame_StagesTemplate.py][Stages Template]]. Please note this is a different template to all prevoius lessons.
...
:HTML_CONTAINER_CLASS: badge
:END:      
- *Silver:* Assemble the game from the template by adding the 4 sections of code above.
- *Gold:* Add a background image and some additional text to the splash. screen 
- *Platinum:* Modify the game to use are own sprites, backgrounds and sounds
