...
while gameState != "exit": # game loop - note: everything in the mainloop is indented one tab
	...
	# pygame.draw.rect(screen, color, (X, Y, width, height), thickness) # thickness is optional
	pygame.draw.rect(screen, yellow, (400, 200, 100, 200), 7)
...
sys.exit()	# close operating window